...
public abstract class PermissionUtil {
     ...
     *
     * @see BaseActivity#onRequestPermissionsResult(int, String[], int[])
     */
     ...
     *
     * @see BaseActivity#checkSelfPermission(String)
     */
    public static boolean hasSelfPermission(BaseActivity activity, String[] permissions) {
     ...
     * @see BaseActivity#checkSelfPermission(String)
     */
    public static boolean hasSelfPermission(BaseActivity activity, String permission) {
        // Below Android M all permissions are granted at install time and are already available.
        if (!isMNC()) {
            return true;
        }
